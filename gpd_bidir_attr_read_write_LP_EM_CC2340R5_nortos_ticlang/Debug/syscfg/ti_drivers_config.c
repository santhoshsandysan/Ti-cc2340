...
static char flashBuf0[0x16000] __attribute__ ((retain, noinit, location(0x6a000)));

#elif defined(__IAR_SYSTEMS_ICC__)

__no_init static char flashBuf0[0x16000] @ 0x6a000;

#elif defined(__GNUC__)

__attribute__ ((section (".nvs")))
static char flashBuf0[0x16000];
